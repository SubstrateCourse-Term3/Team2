...
use futures::prelude::*;
use myproject_runtime::{self, GenesisConfig, opaque::Block, RuntimeApi, WASM_BINARY};
...
native_executor_instance!(
	pub Executor,
	myproject_runtime::api::dispatch,
	myproject_runtime::native_version
);
...
macro_rules! new_full_start {
	($config:expr) => {{
		...
		let builder = substrate_service::ServiceBuilder::new_full::<
			myproject_runtime::opaque::Block, myproject_runtime::RuntimeApi, crate::service::Executor
		>($config)?
			...
			.with_import_queue(|_config, client, mut select_chain, transaction_pool| {
				...
				let (block_import, link_half) =
					grandpa::block_import::<_, _, _, myproject_runtime::RuntimeApi, _, _>(
