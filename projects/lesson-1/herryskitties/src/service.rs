...
use futures::prelude::*;
use herryskitties_runtime::{self, GenesisConfig, opaque::Block, RuntimeApi, WASM_BINARY};
...
native_executor_instance!(
	pub Executor,
	herryskitties_runtime::api::dispatch,
	herryskitties_runtime::native_version
);
...
macro_rules! new_full_start {
	($config:expr) => {{
		...
		let builder = substrate_service::ServiceBuilder::new_full::<
			herryskitties_runtime::opaque::Block, herryskitties_runtime::RuntimeApi, crate::service::Executor
		>($config)?
			...
			.with_import_queue(|_config, client, mut select_chain, transaction_pool| {
				...
				let (block_import, link_half) =
					grandpa::block_import::<_, _, _, herryskitties_runtime::RuntimeApi, _, _>(
