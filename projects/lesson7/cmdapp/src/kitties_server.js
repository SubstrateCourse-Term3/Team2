        ...
        if (event.section === 'kitties') {
            ...
            switch (event.method) {
                case 'Created': {
                    ...
                    if (dna !== null) {
                        await db.runAsync("insert or replace into t_kitties(owner_addr, kitty_index, kitty_dna) values (?,?,?)", kittyEvent[0], kittyEvent[1], dna);
                    }
                    break;
                }
                case 'Transferred': {
                ...
                case 'Ask': {
                    ...
                    if (kittyEvent[2] === null) {
                        ...
                        await db.runAsync("insert or replace into t_kitty_prices(owner_addr, kitty_index, kitty_price) values (?,?,?)", kittyEvent[0], kittyEvent[1], kittyEvent[2]);
                    }
                    break;
                }
                case 'Sold': {
